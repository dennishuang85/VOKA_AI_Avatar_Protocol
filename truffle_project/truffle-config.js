...
const seed_phrase = process.env.BLOCKCHAIN_PHRASE;
...
module.exports = {
  ...
  networks: {
    ...
    // NB: It's important to wrap the provider as a function.
     ...
     matic: {
      provider: () => new HDWalletProvider(seed_phrase, mumbai_link),
      network_id: 80001,
      confirmations: 2,
      timeoutBlocks: 200,
      skipDryRun: true
     ...
     camp_network: {
      provider: () => new HDWalletProvider(seed_phrase, 'https://rpc.camp-network-testnet.gelato.digital'),
      network_id: 325000,
      confirmations: 2,
      timeoutBlocks: 200,
      skipDryRun: true
